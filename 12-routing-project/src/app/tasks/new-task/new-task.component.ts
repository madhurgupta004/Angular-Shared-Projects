...
export class NewTaskComponent {
  ...
  onSubmit() {
    ...
    this.router.navigate(['/users', this.userId(), 'tasks'], {
      replaceUrl: true, // Can't use back button to come back to this page
    });
  }
}
...
export const canLeaveEditPage: CanDeactivateFn<NewTaskComponent> = (
  ...
  if (
    ...
    // Built-in by browser to open a confirmation window (Returns a boolean based on user choice: yes or no)
  }
  return true;
};
